...
export default function AdjustmentsPage() {
  ...
  const createM = useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['adjustments', 'stock', 'stats'] }); toast.success('Adjustment applied'); setOpen(false); setForm({ productId: '', warehouseId: '', adjQty: '', reason: '' }); },
